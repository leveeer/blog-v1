/*
 ...
 Source Server         : 47.119.168.227
 Source Server Type    : MySQL
 Source Server Version : 80025
 Source Host           : 47.119.168.227:3306
 Source Schema         : blog
...
CREATE TABLE `tb_article`  (
  ...
  `is_publish` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否发布 0否 1是',
  `is_delete` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否删除  0否 1是',
  `is_original` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否原创 0否 1是',
  `click_count` int(0) NOT NULL DEFAULT 0 COMMENT '文章点击数',
  `collect_count` int(0) NOT NULL DEFAULT 0 COMMENT '文章收藏数',
...
-- ----------------------------
INSERT INTO `tb_article` VALUES (30, 1, 12, 'https://www.static.talkxj.com/articles/1616249391415.jpg', '测试文章3', '## 测试目录\n这是你的第一篇文章', '2021-03-20 22:09:58', '2021-03-20 23:39:20', 1, 1, 0, 1, 9999, 9999);
...
-- ----------------------------
INSERT INTO `tb_article_tags` VALUES (272, 31, 18, NULL, NULL);
INSERT INTO `tb_article_tags` VALUES (273, 31, 19, NULL, NULL);
...
-- ----------------------------
INSERT INTO `tb_category` VALUES (12, '测试分类', '2021-03-20 22:02:43', NULL);
...
CREATE TABLE `tb_chat_record`  (
  ...
  `content` varchar(5000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '聊天内容',
...
CREATE TABLE `tb_comment`  (
  ...
  `reply_id` int(0) NOT NULL COMMENT '回复用户id',
  `parent_id` int(0) NOT NULL COMMENT '父评论id',
...
CREATE TABLE `tb_menu`  (
  ...
  `update_time` datetime(0) NOT NULL COMMENT '更新时间',
  `order_num` tinyint(0) NOT NULL COMMENT '排序',
  `parent_id` int(0) NOT NULL COMMENT '父id',
  `is_disable` tinyint(1) NOT NULL COMMENT '是否禁用 0否1是',
  `is_hidden` tinyint(1) NOT NULL COMMENT '是否隐藏  0否1是',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of tb_menu
-- ----------------------------
INSERT INTO `tb_menu` VALUES (1, '首页', '/', '/home/Home.vue', 'el-icon-myshouye', '2021-01-26 17:06:51', '2021-01-26 17:06:53', 1, 0, 0, 0);
INSERT INTO `tb_menu` VALUES (2, '文章管理', '/article-submenu', 'Layout', 'el-icon-mywenzhang-copy', '2021-01-25 20:43:07', '2021-01-25 20:43:09', 2, 0, 0, 0);
INSERT INTO `tb_menu` VALUES (3, '消息管理', '/message-submenu', 'Layout', 'el-icon-myxiaoxi', '2021-01-25 20:44:17', '2021-01-25 20:44:20', 3, 0, 0, 0);
INSERT INTO `tb_menu` VALUES (4, '系统管理', '/system-submenu', 'Layout', 'el-icon-myshezhi', '2021-01-25 20:45:57', '2021-01-25 20:45:59', 5, 0, 0, 0);
INSERT INTO `tb_menu` VALUES (5, '个人中心', '/setting', '/setting/Setting.vue', 'el-icon-myuser', '2021-01-26 17:22:38', '2021-01-26 17:22:41', 7, 0, 0, 0);
...
INSERT INTO `tb_menu` VALUES (19, '日志管理', '/log-submenu', 'Layout', 'el-icon-myguanyuwo', '2021-01-31 21:33:56', '2021-01-31 21:33:59', 6, 0, 0, 0);
...
INSERT INTO `tb_menu` VALUES (202, '用户管理', '/users-submenu', 'Layout', 'el-icon-myyonghuliebiao', '2021-02-06 23:44:59', '2021-02-06 23:45:03', 4, 0, 0, 0);
...
CREATE TABLE `tb_message`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3433 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `tb_operation_log`  (
  ...
  `ip_addr` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '操作ip',
...
CREATE TABLE `tb_resource`  (
  ...
  `url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '权限路径',
  `request_method` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '请求方式',
  `parent_id` int(0) NOT NULL COMMENT '父权限id',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL COMMENT '修改时间',
  `is_disable` tinyint(1) NOT NULL COMMENT '是否禁用 0否 1是',
  `is_anonymous` tinyint(0) NOT NULL COMMENT '是否匿名访问 0否 1是',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `tb_resource` VALUES (165, '分类模块', ' ', ' ', 0, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (166, '博客信息模块', ' ', ' ', 0, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (167, '友链模块', ' ', ' ', 0, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (168, '文章模块', ' ', ' ', 0, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (169, '日志模块', ' ', ' ', 0, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (170, '标签模块', ' ', ' ', 0, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (171, '用户信息模块', ' ', ' ', 0, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (172, '用户账号模块', ' ', ' ', 0, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (173, '留言模块', ' ', ' ', 0, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (174, '菜单模块', ' ', ' ', 0, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (175, '角色模块', ' ', ' ', 0, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (176, '评论模块', ' ', ' ', 0, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
INSERT INTO `tb_resource` VALUES (177, '资源模块', ' ', ' ', 0, '2021-03-20 22:56:20', '2021-03-20 22:56:20', 0, 0);
...
CREATE TABLE `tb_role_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1265 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `tb_role_resource`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4177 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
-- Records of tb_tag
-- ----------------------------
INSERT INTO `tb_tag` VALUES (18, '测试标签', '2021-03-20 22:02:51', '2021-05-20 18:08:30', 1, 0);
INSERT INTO `tb_tag` VALUES (19, 'java', '2021-05-23 01:29:20', '2021-05-23 01:29:23', 1, 1);
...
CREATE TABLE `tb_user_auth`  (
  ...
  `ip_addr` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '用户登录ip',
...
CREATE TABLE `tb_user_info`  (
  ...
  `email` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '邮箱号',
  ...
  `intro` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '用户简介',
...
-- ----------------------------
INSERT INTO `tb_user_info` VALUES (1, '1519695805@qq.com', 'Einson', 'http://qt36u2hdb.hn-bkt.clouddn.com/user1.jpg', '发表你的第一篇博客吧', 'https://www.talkxj.com', '2020-06-29 10:48:18', '2021-03-20 22:10:33', 0);
