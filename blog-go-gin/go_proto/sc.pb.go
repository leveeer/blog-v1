...
var file_sc_proto_rawDesc = []byte{
	...
	0x6f, 0x1a, 0x0a, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd2, 0x07,
	...
	0x74, 0x61, 0x22, 0x91, 0x01, 0x0a, 0x06, 0x53, 0x63, 0x43, 0x68, 0x61, 0x74, 0x12, 0x12, 0x0a,
	...
	0x52, 0x61, 0x6e, 0x6b, 0x4c, 0x69, 0x73, 0x74, 0x2a, 0x22, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70,
...
var file_sc_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_sc_proto_goTypes = []interface{}{
	...
	(*ArticlesByCategoryOrTag)(nil), // 9: proto.ArticlesByCategoryOrTag
	(*Tag)(nil),                     // 10: proto.Tag
	(*Message)(nil),                 // 11: proto.Message
	(*FriendLink)(nil),              // 12: proto.FriendLink
	(*CommentInfo)(nil),             // 13: proto.CommentInfo
	(*LoginResponse)(nil),           // 14: proto.LoginResponse
	(*Article)(nil),                 // 15: proto.Article
	(*BlogHomeInfo)(nil),            // 16: proto.BlogHomeInfo
	(*ArticleInfo)(nil),             // 17: proto.ArticleInfo
	(*Archives)(nil),                // 18: proto.Archives
	(*About)(nil),                   // 19: proto.About
	(*Reply)(nil),                   // 20: proto.Reply
	(*UniqueView)(nil),              // 21: proto.UniqueView
	(*ArticleRank)(nil),             // 22: proto.ArticleRank
}
var file_sc_proto_depIdxs = []int32{
	...
	8,  // 2: proto.ResponsePkg.categories:type_name -> proto.Category
	9,  // 3: proto.ResponsePkg.articlesByCategoryOrTag:type_name -> proto.ArticlesByCategoryOrTag
	10, // 4: proto.ResponsePkg.tags:type_name -> proto.Tag
	11, // 5: proto.ResponsePkg.messages:type_name -> proto.Message
	12, // 6: proto.ResponsePkg.friendLinks:type_name -> proto.FriendLink
	13, // 7: proto.ResponsePkg.commentInfo:type_name -> proto.CommentInfo
	14, // 8: proto.ResponsePkg.loginResponse:type_name -> proto.LoginResponse
	15, // 9: proto.ResponsePkg.articleList:type_name -> proto.Article
	16, // 10: proto.ResponsePkg.blogHomeInfo:type_name -> proto.BlogHomeInfo
	17, // 11: proto.ResponsePkg.articleInfo:type_name -> proto.ArticleInfo
	18, // 12: proto.ResponsePkg.archiveInfo:type_name -> proto.Archives
	19, // 13: proto.ResponsePkg.about:type_name -> proto.About
	20, // 14: proto.ResponsePkg.replyList:type_name -> proto.Reply
	...
	4,  // 18: proto.ScChat.scChatOnline:type_name -> proto.ScChatOnline
	5,  // 19: proto.ScChat.scChatMessage:type_name -> proto.ScChatMessage
	6,  // 20: proto.ScUserMenuMessage.children:type_name -> proto.ScUserMenuMessage
	8,  // 21: proto.ScAdminHomeData.categoryList:type_name -> proto.Category
	21, // 22: proto.ScAdminHomeData.uniqueViewList:type_name -> proto.UniqueView
	22, // 23: proto.ScAdminHomeData.articleRankList:type_name -> proto.ArticleRank
