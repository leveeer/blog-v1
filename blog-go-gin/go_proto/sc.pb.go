...
type ScUserMenuMessage struct {
	...
	Children  *ScUserMenuMessage `protobuf:"bytes,6,opt,name=children,proto3" json:"children,omitempty"`
}
...
var file_sc_proto_rawDesc = []byte{
	...
	0x63, 0x68, 0x69, 0x6c, 0x64, 0x72, 0x65, 0x6e, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18,
