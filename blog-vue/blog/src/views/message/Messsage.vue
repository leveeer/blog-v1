...
<script>
  import { addMessages, getMessages } from "../../api/api";
      ...
      listMessage() {
        getMessages().then((data) => {
          if (data) {
            ...
            this.barrageList = data.messages;
          }
        });
      }
    }
...
<style scoped>
  .message-banner {
    ...
    right: 0;
    height: 100vh;
    background: #49b1f5 url(https://www.static.talkxj.com/d5ojdj.jpg) no-repeat center center;
