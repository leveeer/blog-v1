<template>
  <div>
    <!-- 封面图 -->
    <div class="banner" :style="article.articleCover">
      <div class="article-info-container">
        ...
        <div class="article-info">
          ...
          <div class="third-line">
            ...
            <!-- 阅读量 -->
            <span>
              <i class="iconfont iconliulan" /> 阅读量: {{ article.clickCount }}
            </span>
            <span class="separator">|</span>
            <!-- 评论量 -->
            <span>
        ...
        <v-card class="article-wrapper">
          ...
          <div class="article-reward">
            ...
            <a :class="isLike" @click="like">
              ...
              点赞
              <span v-show="article.collectCount > 0">{{
    ...
    methods: {
      ...
      listComment() {
        ...
        getComments({
          ...
          .then((data) => {
            console.log(data);
            this.commentList = data.commentInfo.commentList;
            this.count = data.commentInfo.count;
          });
      },
      like() {
        // 判断登录
